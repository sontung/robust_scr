...
#python -u ace_trainer_with_loftr2.py  --scene $SCENE_PATH --global_feat 1 --use_aug 1 --iter_output 1000000 --depth_target 12 --feat_name checkpoints/desc_aachen22.npy  --feat_name_test checkpoints/desc_aachen22_test.npy   --training_buffer_size 128000000 --max_iterations 100000 --batch_size 320000 --graph_aug 1 --use_half 1 --focus_tune 1 --output_map_file head.pth
#
#python train_agg_aachen.py $SCENE_PATH 0 desc_aachen22 64 10000 0 16 1e-5 9e-10 1 2
#python -u ace_trainer_with_loftr2.py  --scene $SCENE_PATH --global_feat 1 --use_aug 1 --iter_output 1000000 --depth_target 12 --feat_name checkpoints/desc_aachen22.npy  --feat_name_test checkpoints/desc_aachen22_test.npy   --training_buffer_size 128000000 --max_iterations 100000 --batch_size 320000 --graph_aug 1 --use_half 1 --focus_tune 1 --output_map_file head.pth

#python train_agg_aachen.py $SCENE_PATH 0 desc_aachen22 64 10000 0 16 1e-5 9e-10 1 4
#python -u ace_trainer_with_loftr2.py  --scene $SCENE_PATH --global_feat 1 --use_aug 1 --iter_output 1000000 --depth_target 12 --feat_name checkpoints/desc_aachen22.npy  --feat_name_test checkpoints/desc_aachen22_test.npy   --training_buffer_size 128000000 --max_iterations 100000 --batch_size 320000 --graph_aug 1 --use_half 1 --focus_tune 1 --output_map_file head.pth

python train_agg_aachen.py $SCENE_PATH 0 desc_aachen22 128 10000 0 16 1e-5 9e-10 1 2
python -u ace_trainer_with_loftr2.py  --scene $SCENE_PATH --global_feat 1 --use_aug 1 --iter_output 1000000 --depth_target 12 --feat_name checkpoints/desc_aachen22.npy  --feat_name_test checkpoints/desc_aachen22_test.npy   --training_buffer_size 128000000 --max_iterations 100000 --batch_size 320000 --graph_aug 1 --use_half 1 --focus_tune 1 --output_map_file head.pth

#python train_agg_aachen.py $SCENE_PATH 0 desc_aachen22 128 10000 0 16 1e-5 9e-10 1 4
#python -u ace_trainer_with_loftr2.py  --scene $SCENE_PATH --global_feat 1 --use_aug 1 --iter_output 1000000 --depth_target 12 --feat_name checkpoints/desc_aachen22.npy  --feat_name_test checkpoints/desc_aachen22_test.npy   --training_buffer_size 128000000 --max_iterations 100000 --batch_size 320000 --graph_aug 1 --use_half 1 --focus_tune 1 --output_map_file head.pth
