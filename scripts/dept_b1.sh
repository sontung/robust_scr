...
python train_agg.py $SCENE_PATH 0 desc_b1 128 10000 1 16 1e-5 9e-10 0 2

python -u ace_trainer_with_dept.py  --scene $SCENE_PATH --global_feat 1 --use_aug 1 --iter_output 1000000 --feat_name checkpoints/desc_b1.npy  --feat_name_test checkpoints/desc_b1_test.npy  --training_buffer_size 128000000 --max_iterations 100000 --batch_size 320000 --graph_aug 1 --use_half 1 --focus_tune 0 --grad_acc 2 --depth_init 1 --output_map_file head_b1.pth
