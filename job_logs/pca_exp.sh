...
/home/n11373598/.pixi/bin/pixi run python -u ace_trainer_with_loftr2.py  --scene $SCENE_PATH --pca_path "proc/pcad3LB_64.pth" --reuse_buffer 0 --global_feat 1 --use_aug 1 --iter_output 1000000 --depth_target 12 --feat_name checkpoints/desc_aachen0.npy  --feat_name_test checkpoints/desc_aachen0_test.npy   --training_buffer_size 128000000 --max_iterations 100000 --batch_size 320000 --graph_aug 1 --use_half 1 --focus_tune 1 --output_map_file head_main.pth
/home/n11373598/.pixi/bin/pixi run python -u ace_trainer_with_loftr2.py  --scene $SCENE_PATH --pca_path "proc/pcad3LB_32.pth" --reuse_buffer 0 --global_feat 1 --use_aug 1 --iter_output 1000000 --depth_target 12 --feat_name checkpoints/desc_aachen0.npy  --feat_name_test checkpoints/desc_aachen0_test.npy   --training_buffer_size 128000000 --max_iterations 100000 --batch_size 320000 --graph_aug 1 --use_half 1 --focus_tune 1 --output_map_file head_main.pth
/home/n11373598/.pixi/bin/pixi run python -u ace_trainer_with_loftr2.py  --scene $SCENE_PATH --pca_path "proc/pcad3LB_16.pth" --reuse_buffer 0 --global_feat 1 --use_aug 1 --iter_output 1000000 --depth_target 12 --feat_name checkpoints/desc_aachen0.npy  --feat_name_test checkpoints/desc_aachen0_test.npy   --training_buffer_size 128000000 --max_iterations 100000 --batch_size 320000 --graph_aug 1 --use_half 1 --focus_tune 1 --output_map_file head_main.pth
/home/n11373598/.pixi/bin/pixi run python -u ace_trainer_with_loftr2.py  --scene $SCENE_PATH --pca_path "proc/pcad3LB_8.pth" --reuse_buffer 0 --global_feat 1 --use_aug 1 --iter_output 1000000 --depth_target 12 --feat_name checkpoints/desc_aachen0.npy  --feat_name_test checkpoints/desc_aachen0_test.npy   --training_buffer_size 128000000 --max_iterations 100000 --batch_size 320000 --graph_aug 1 --use_half 1 --focus_tune 1 --output_map_file head_main.pth
